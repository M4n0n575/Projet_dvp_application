...
def main():
    ...
    # Configuration de la fenêtre (600x600 pour la grille 10x10 avec des cases de 60)
    ...
    menu = Menu(screen)
    jeu = None
    etat = "MENU" # Etats possibles : MENU, JEU
    
    # Essaie de chargement de la musique du menu
    try:
